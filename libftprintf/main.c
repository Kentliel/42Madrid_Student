...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/24 16:27:25 by kcarrero          #+#    #+#             */
/*   Updated: 2025/05/24 16:38:46 by kcarrero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    printf("ft_printf chars: %d, Original chars: %d\n\n", my_chars, original_chars);
    my_chars = ft_printf("ft_printf Caracter nulo: %c\n", '\0');
    original_chars = printf("Original: Caracter nulo: %c\n", '\0');
